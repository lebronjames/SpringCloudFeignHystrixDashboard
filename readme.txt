...
1) pom.xml增加Feign(spring-cloud-starter-feign)、eureka(spring-cloud-starter-eureka)
spring-cloud-starter-hystrix-dashboard配置
...
spring.application.name=feign-hystrix-consumer-dashboard
server.port=3833
